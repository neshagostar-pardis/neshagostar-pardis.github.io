# CNC Robot Programming Tutorial
...
### **C. ABB Robot Programming (RAPID with Machining PowerPac)**
...
### **B. Adaptive Cutting with Surface Following**
...
#### **3. Positioning Accuracy Problems**
```
